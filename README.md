...
For this assignment, our task was to build the back end for an e-commerce site. I took a working Express.js API and configured it to use Sequelize to interact with a MySQL database.
...
To install the project, you need to use git clone and git pull from <a href ="https://github.com/abauer424/lets-go-ecommerce">my repository.</a> 
...
Please view the license <a href="https://github.com/abauer424/lets-go-ecommerce/blob/main/LICENSE">here.</a>
